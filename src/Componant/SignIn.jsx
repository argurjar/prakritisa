...
const SignIn = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`https://prakritisa.com${url}`, {
                method: 'POST',
                headers: {
                ...
                <div className="signin_inner_cont">
                    ...
                    <form onSubmit={handleSubmit}   >
                        ...
                        <div className="form_group w-100">
                            <input value={email}
                                onChange={(e) => setEmail(e.target.value.toLowerCase())}  pattern="^[^\s@]+@[^\s@]+\.[^\s@]+$"  title="Please enter a valid email address" type="email" className="form_control" placeholder='Email ' required />
                        </div>
                        <div className="form_group w-100">
                            <input value={mobile}
                                onChange={(e) => setMobile(e.target.value)}  pattern="^[6-9][0-9]{9}$"  title="Please enter a valid 10-digit phone number starting with 6-9" type="tel" className="form_control" placeholder='Contact' required />
                        </div>
