                ...
                <div className="product-card">
                  <div className="product-img-wrapper">
                    <Link to={`/products/${product.slug}`}>
                      <img src={`https://prakritisa.com/uploads/thumbImg/${product.thumbImg}`} alt={product.name} className="img-main" />
                      <img src={`https://prakritisa.com/uploads/galleryImg/${product.galleryImg[0]}`} alt={product.name} className="img-hover" />
                    </Link>
                    <div
